...
### [AutoPaper — Local Markdown Reader](autopaper/)

Chrome / Edge Manifest V3 扩展。把本地文件夹变成可搜索的 Markdown 文库，并将文档排版为带目录的阅读页；也提供离线双栏编辑与实时预览。

- 无账号、广告、分析脚本或远程代码；
- Markdown 内容和草稿只在当前浏览器处理；
- 支持标题、列表、引用、代码块、表格、链接、图片与离线 Mermaid 图表；图表可缩放、全屏查看并导出 SVG/PNG；
- 文件夹支持面包屑、即时搜索、Markdown 筛选及按名称、修改时间和大小排序；
